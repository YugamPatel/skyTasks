...
import { Moon, Search, Settings, Sun, Menu, User } from "lucide-react";
        ...
        <div className="hidden items-center justify-between md:flex">
          <div className="align-center flex h-9 w-9 justify-center">
            {!!currentUserDetails?.profilePictureUrl ? (
              <Image
                src={`https://pm-s3-bucket-yugam.s3.us-east-2.amazonaws.com/${currentUserDetails?.profilePictureUrl}`}
