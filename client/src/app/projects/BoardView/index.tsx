...
const Task = ({ task }: TaskProps) => {
  ...
  const formattedStartDate = task.startDate ? "27th Jan 2023" : "";
  const formattedDueDate = task.dueDate ? "27th Jan 2023" : "";
  ...
  return (
    ...
    >
      {task.attachments && task.attachments.length > 0 && (
        <div className="h-auto w-full overflow-hidden rounded-t-md p-2">
          <Image
            src={`https://pm-s3-bucket-yugam.s3.us-east-2.amazonaws.com/${task.attachments[0].fileURL}`}
      ...
      <div className="p-4 md:p-6">
        ...
        <div className="mt-3 flex items-center justify-between">
          <div className="flex -space-x-[6px] overflow-hidden">
            {task.assignee && (
              <Image
                src={`https://pm-s3-bucket-yugam.s3.us-east-2.amazonaws.com/${task.assignee.profilePictureUrl}`}
                alt={task.assignee.username}
                width={30}
                height={30}
                className="dark:border-dark-secondary h-8 w-8 rounded-full border-2 border-white"
              />
            )}
            {task.author && (
              <Image
                src={`https://pm-s3-bucket-yugam.s3.us-east-2.amazonaws.com/${task.author.profilePictureUrl}`}
